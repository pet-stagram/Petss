...
module.exports = class DirectMessage extends Sequelize.Model{
    ...
    static associate(db){
        ...
        db.DirectMessage.belongsTo(db.User,{foreignKey:"to"});
        /*  Chat 테이블에서 chat_id이라는 컬럼명으로 foreign key 참조하여 가져옴*/
        db.DirectMessage.belongsTo(db.User,{foreignKey:"from"});
        
        // db.DirectMessage.belongsTo(db.ChatRoom,{foreignKey:"chat_id"});
